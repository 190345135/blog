...
export default class PixelBlast {
    ...
    mapToPixels(e) {
        ...
        return { fx, fy, w: this.canvas.width, h: this.canvas.height };
    }
    ...
    onResize() {
        ...
        this.uniforms.uResolution.value.set(width * this.renderer.getPixelRatio(), height * this.renderer.getPixelRatio());
        if (this.composer) {
            this.composer.setSize(width * this.renderer.getPixelRatio(), height * this.renderer.getPixelRatio());
        }
